...
To get started, look at the existing [**Issues**](https://github.com/chatreejs/sushi/issues) or [**create a new issue**](https://github.com/chatreejs/sushi/issues/new/choose)!

### Setup guidelines 🪜

Follow these steps to setup Sushi on your local machine

1. [Fork](https://github.com/chatreejs/sushi/fork) the project
2. Clone the project to run on your local machine using the following command:

   ```sh
   git clone https://github.com/<your_github_username>/sushi.git
   ```
...
11. Create a [PULL REQUEST](https://github.com/chatreejs/sushi/compare) 💣
...
- Select an issue template from the [issues](https://github.com/chatreejs/sushi/issues/new/choose) tab. Otherwise, choose **Other** if it doesn't match what you're looking for.
...
4. Use our [Commit messages Guidelines](https://github.com/chatreejs/sushi/blob/main/CONTRIBUTING.md#commits-message-guidelines-) for your changes.
...
- If something is missing here, or you feel something is not well described, either create a PR, [raise an issue](https://github.com/chatreejs/sushi/issues), or [do a code review of the person’s PR](https://www.freecodecamp.org/news/code-review-tips/) (ensure that your review conforms to the [Code of Conduct](https://github.com/chatreejs/sushi/blob/main/CODE_OF_CONDUCT.md))

- You can tag maintainers for any kind of difficulty using `@username`. You can find the list of maintainer usernames [here](https://github.com/chatreejs/sushi/blob/main/README.md#maintainers-).
